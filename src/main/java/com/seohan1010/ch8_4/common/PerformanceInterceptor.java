...
//
//@Component
//public class PerformanceInterceptor implements HandlerInterceptor {//  단일 책임의 원칙 (SRP)하나의 메서드는 하나의 책임만
//                                                                    // 갖는다.
////            long startTime = System.currentTimeMillis(); //인스턴스 변수. 싱글톤(하나의 객체)이라서 여러 쓰레드가 하나의 객체를 공유
//    @Override
